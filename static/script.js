...
const COMMANDS = ["neofetch", "cowsay \"Hello World\"", "cargo run", 
"ping vvill.dev", "sudo rm -rf --no-preserve-root /", "sudo pacman -Syu", 
"echo Go Beavs", "git commit -am \"I did a thing\"", "pandoc a.md -o a.pdf", 
"man man", "systemctl list services", ":(){ :|:& };:", "sudo nvim -b /bin/bash", 
"nvim +q"];
...
function swapContent(e, i){
    if(window.innerHeight > window.innerWidth){
        ...
        //Not always an image for the post
        if(img.tagName == 'IMG'){
